...
AS $$
DECLARE
  project_url TEXT := 'https://vyrmszlqzkokwxpyfggv.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZ5cm1zemxxemtva3d4cHlmZ2d2Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwODk0NTQzMiwiZXhwIjoyMDI0NTIxNDMyfQ.0sh7AM1uNRo0wUnUF7RA7AzHEfbgTJz_1VwD0oEVTjs'; -- full access needed for http request to storage
